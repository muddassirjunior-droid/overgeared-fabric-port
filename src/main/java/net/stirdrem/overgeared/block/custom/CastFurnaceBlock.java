...
public class CastFurnaceBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return AbstractSmithingAnvil.validateTicker(type, ModBlockEntities.CAST_FURNACE_BE, CastFurnaceBlockEntity::tick);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        if (state.get(LIT)) {
            ...
            if (random.nextDouble() < 0.1D) {
                ...
                world.playSound(d0, d1, d2, SoundEvents.BLOCK_SMOKER_SMOKE, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
            }

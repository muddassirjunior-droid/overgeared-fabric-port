...
public class NetherAlloySmelterBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return AbstractSmithingAnvil.validateTicker(type, ModBlockEntities.NETHER_ALLOY_FURNACE_BE, NetherAlloySmelterBlockEntity::tick);
    }
